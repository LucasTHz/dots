...
_G.packer_plugins = {
  ...
  ["DAPInstall.nvim"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/DAPInstall.nvim",
  ...
  ["cmp-under-comparator"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/cmp-under-comparator",
  ...
  ["live-server.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/live-server.nvim",
